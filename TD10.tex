...
\formation{L2 MIASHS}
\titre{TD10 : Combinaison de sources : Rennes 2 Express}
\begin{document}
...
\section*{Préambule}
\begin{itemize}
    \item Dans votre dossier PythonOpenData créez un sous-dossier TD10.
    \item Lancer l'éditeur Visual Studio Code.
    \item Dans Visual Studio Code, ouvrir le dossier PythonOpenData/TD10 et créez un fichier TD10.py dans lequel vous écrirez votre code. 
\end{itemize}
...
Téléchargez les fichiers CSV depuis CURSUS et enregistrez-les dans votre dossier \texttt{PythonOpenData/TD10}.
